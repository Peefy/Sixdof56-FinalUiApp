...
#define IDC_BUTTON_OIL_START_SHOW_TEXT      "油源开"
#define IDC_BUTTON_OIL_ING_START_SHOW_TEXT  "正在打开..."
#define IDC_BUTTON_SHOW_ROADDATA_SHOW_TEXT  "数据回放"
#define IDC_BUTTON_REPRODUCE_SHOW_TEXT      "路谱复现"
#define IDC_BUTTON_SET_MID_POS_SHOW_TEXT    "设置中立位"
#define IDC_BUTTON_FINISH_ING_SHOW_TEXT     "正在关闭..."
